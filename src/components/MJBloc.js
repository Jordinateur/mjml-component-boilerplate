    ...
    return this.renderMJML(`
      <mj-group background-color="#1F8D9D" padding="0" width="${this.getAttribute('width')}">
        <mj-column width="20%" background-color="#d9e4e6" vertical-align="middle" padding="8px 3px">
          <mj-image src="${this.getAttribute('var-picto')}" padding="0" width="60px" fluid-on-mobile="true"/>
        </mj-column>
        <mj-column width="78%" background-color="#1F8D9D" padding="0" vertical-align="middle">
